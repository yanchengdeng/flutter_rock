/*
 * @Author: 凡琛
 * @Date: 2021-06-24 15:54:46
 * @LastEditTime: 2021-06-25 10:40:19
 * @LastEditors: Please set LastEditors
 * @Description: 输入框组件
 * @FilePath: /Rocks_Flutter/lib/pages/common/loginTextField.dart
 */
    ...
    Stack(
      ...
      children: <Widget>[
        ...
        TextField(
          ...
          style: _textStyle,
          inputFormatters: [FilteringTextInputFormatter.allow(RegExp('[\u4e00-\u9fa5_a-zA-Z]')),LengthLimitingTextInputFormatter(20)],
...
//          suffixIcon:
        ...
        TextField(
          ...
          style: _textStyle,
           ...
           inputFormatters: widget.show?(widget.keyboardType == TextInputType.number || widget.keyboardType == TextInputType.phone)?
           [FilteringTextInputFormatter.allow(RegExp('[0-9]')),LengthLimitingTextInputFormatter(widget.maxLength)] : [FilteringTextInputFormatter.deny(RegExp('[\u4e00-\u9fa5]')),LengthLimitingTextInputFormatter(widget.maxLength)]:
