...
class HDFormSelectCell extends StatefulWidget {
  final String title;
  final String text;
  ...
  const HDFormSelectCell({
    Key key,
    this.cellHeight: 45.0,
    this.title: '',
    this.text: '',
    this.hintText: '请选择',
  ...
  @override
  _HDFormSelectCellState createState() => _HDFormSelectCellState();
}

class _HDFormSelectCellState extends State<HDFormSelectCell> {
