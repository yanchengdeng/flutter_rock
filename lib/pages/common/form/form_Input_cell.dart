...
class HDFormInputCell extends StatefulWidget {
  final String title;
  final String text;
  ...
  @override
  _HDFormInputCellState createState() => _HDFormInputCellState();
}

class _HDFormInputCellState extends State<HDFormInputCell> {
  @override
